...
%---------------------------------------------------------
  ...
  {Anviplas (Repeats Iberia)} % Organization
  {Manresa, España} % Location
  {desde diciembre 2022} % Date(s)
  {
    \begin{cvitems} % Description(s) of tasks/responsibilities
      \item {Management et gestion de 8 équipes de production (fonctionnement 24/7)}
      \item {Suivi et optimisation de la production}
      \item {Analyse des rapports de production et reporting auprès de la direction}
      \item {Transition d'une usine traditionnelle familiale à une usine industrielle informatisée}
      \item {Migration des processus de production vers Microsoft Dynamics 365 Supply Chain Managemnent}
    \end{cvitems}
  }
